import{p as kt,u as vt,i as V,g as u,t as re,r as Ft,l as j,b as St,s as K,v as $,n as w,c as P,e as z,m as U,j as te,o as ne,d as Yt,h as Cn,k as Q,w as is,a as Ce,x as ss,$ as Yn,y as rs,f as Le,z as as,A as fi,B as Ge,C as os,I as ls,D as cs,q as us}from"./Installation-CWd2cBZK.js";import{p as De,b as hi,a as fs,d as hs,m as ds,n as di,c as ps,A as ms,h as gs,r as bs,e as ys,B as vs,f as He,s as _s,g as We,i as pi,C as gn,N as ws,j as ks,k as Ss,R as Ns,l as Os,o as As,q as Qn,t as Es,u as Ls,v as Ts,w as Is,x as Cs,y as qs,z as Ms,D as Ps,E as js,F as Bs,G as Ds,H as Rs,I as Ks,P as $s,S as Fs,J as Us,K as xs,L as zn}from"./Reglages-Buds9BES.js";import{a as Ut}from"./features-DfOghPAs.js";var Js=U('<label class="memoriser svelte-odrj32"><input type="checkbox"/> Mémoriser sur cet appareil</label>'),Vs=U(`<p class="memoriser svelte-odrj32">La phrase ne peut pas être mémorisée hors de l'application installée.</p>`),Gs=U('<p class="refus svelte-odrj32" role="alert"> </p>'),Hs=U(`<div class="ecran svelte-odrj32"><form class="svelte-odrj32"><h1 class="svelte-odrj32">Philo</h1> <p class="invite svelte-odrj32">Phrase de passe</p> <input type="password" autocomplete="current-password" autocapitalize="none" autocorrect="off" spellcheck="false" enterkeyhint="go" aria-label="Phrase de passe" class="svelte-odrj32"/> <!> <button type="submit" class="svelte-odrj32"> </button> <!> <p class="note svelte-odrj32">La phrase n'est écrite nulle part. « Mémoriser » garde sur cet appareil une clé
